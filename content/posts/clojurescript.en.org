...
#+date: 2025-01-01
#+summary: Step-by-step guide to building a ClojureScript web project with hot-reloading via FigWheel Main and declarative UI using Reagent. From setup to a working counter.
#+options: \n:t
#+toc: t
#+DRAFT: false
#+AUTHOR: Oleg Veschin
